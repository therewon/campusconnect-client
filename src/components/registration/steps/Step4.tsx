                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-lg">
                    ...
                    <div className="lg:col-span-3 space-y-lg">
                            ...
                            <div className="space-y-lg">
                                <div className="relative">
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <input
                                            className="h-12 flex-1 rounded-r-lg border border-outline-variant sm:px-md max-sm:w-full px-sm focus:ring-2 focus:ring-primary focus:border-transparent outline-none font-body-md"
                        ...
                        <div className="flex flex-col sm:flex-row gap-md pt-md">
                            <Link to="/"
                                className="flex-1 bg-primary text-white! py-md rounded-lg font-title-md text-title-md font-bold shadow-lg shadow-primary/20 hover:bg-primary/90 transition-all active:scale-95 flex items-center justify-center gap-sm">
                                Dashboard-a keçid{" "}
                                <span className="material-symbols-outlined">arrow_forward</span>
                            </Link>
                            <button className="sm:w-1/3 border-2 border-primary text-primary py-md  rounded-lg font-title-md text-title-md font-semibold hover:bg-primary/5 transition-colors">
                                Yadda Saxla
                            </button>
                        </div>
